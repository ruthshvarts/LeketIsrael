...
function showFilterOption(tdObject) {
  ...
  filterGrid.append('<div class="select-all"><input id="all" type="checkbox" checked/><label for="all">בחר הכל</label></div>');
  ...
  filterGrid.append('<div><input id="close" type="button" value="סגור"/><input id="ok" type="button" value="אישור"/></div>');
  filterGrid.show();
  ...
  $okBtn.click(function() {
    // Clear the previous filtering
    $(tdObject).parents("table").find("tbody tr").show();
